...
const About: React.FC = () => {
  ...
  const leftContent = (
    <>
      ...
      <p className='m-b-md'>
        ...
        design systems, and application state management. Over the years,
        I&apos;ve worked cross-functionally with high caliber design teams on
        complex problems. Most recently, I&apos;ve been working to create supply
  ...
  return (
    <>
      <NextSeo {...SEO} />
      <SplitLayout left={leftContent} right={rightContent}></SplitLayout>
    </>
  );
};
